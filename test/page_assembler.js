...
describe( 'A PageAssembler', () => {
   ...
   beforeEach( () => {
      ...
      pageAssembler = createPageAssembler( validators, pagesByRef );
   } );
   ...
   describe( 'when instantiating a widget', () => {
      ...
      beforeEach( () => {
         ...
         compile( widgetSchema, 'widgetWithSchema' );
         compile( otherWidgetSchema, 'otherWidgetWithSchema' );
         compile( schemaUsingFormats, 'widgetUsingFormats' );
