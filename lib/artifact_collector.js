 ...
 *
 * @return {ArtifactCollectorApi} the created artifact collector.
 */
exports.create = function( log, options ) {
    ...
    *    a promise to an array of flow-meta objects
    */
    ...
    *    a list of flow artifacts as returned by {@link ArtifactCollectorApi#collectFlows}
    * @return {Promise<Array>}
    *   a promise to a combined array of page meta information for these flows
    */
   function collectPages( flows ) {
      ...
      function followPageRecursively( pageRef ) {
         return followPage( pageRef )
            .then( pages => Promise.all( [ Promise.resolve( pages ) ].concat( pages.map( followPageToPages ) ) ) )
            .then( flatten );
      }
    ...
    * @param {Array} themes
    * @return {Promise<Array>}
    *    a promise for meta-information about all reachable widgets.
    */
    ...
    * @param {Array} themes
    * @return {Promise<Array>}
    *    a promise for meta-information about all controls referenced by the given widgets
    */
