...
exports.create = function create( log, options ) {
   ...
   function resolveThemeAssets( theme ) {
      ...
      return lookupAssets( assetPaths, [ theme.path ] )
   ...
   function resolveLayoutAssets( layout, themes ) {
      ...
      return resolveArtifactAssets( layout, themes, assetPaths, themePaths );
   }
   ...
   function resolveWidgetAssets( widget, themes ) {
      ...
      return resolveArtifactAssets( widget, themes, assetPaths, themePaths );
   }
   ...
   function resolveControlAssets( control, themes ) {
      ...
      return resolveArtifactAssets( control, themes, assetPaths, themePaths );
   }

   function resolveArtifactAssets( artifact, themes, assetPaths, themePaths ) {
      return Promise.all( themes.map( theme => lookupAssets( assetPaths, themePaths( theme ) )
            .then( assets => ( { [ theme.name ]: assets } ) ) ) )
         .then( merge );
   }
