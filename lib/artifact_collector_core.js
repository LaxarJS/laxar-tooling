...
exports.create = function( log, options ) {
   ...
   function followTheme( themeRef ) {
      const themeName = path.basename( themeRef );

      return ( ( themeName === 'default.theme' ) ?
            resolveFile( '.', 'laxar-path-default-theme' ) :
            resolveFile( themeRef, 'laxar-path-themes' ) )
         .then( themePath => [ {
            refs: [ themeRef ],
            name: themeName,
            path: themePath
